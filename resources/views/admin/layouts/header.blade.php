...
<head>
    ...
    <!-- Date Picker -->
    <link rel="stylesheet"
        href="{{ url('') }}/design/admin/bower_components/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css">
    <!-- Daterange picker -->
    <link rel="stylesheet"
        href="{{ url('') }}/design/admin/bower_components/bootstrap-daterangepicker/daterangepicker.css">
  ...
  <![endif]-->
    ...
    <link rel="stylesheet" href="{{ url('design/admin') }}/style/bootstrap-4-utilities.min.css">
    <link rel="stylesheet" href="{{ url('design/admin') }}/style/main.css">
